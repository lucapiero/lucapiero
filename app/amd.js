(function () {
    ...
    requirejs.config({
        ...
        paths: {
            ...
            // Zurb Foundation
            'foundation.core': ['//cdnjs.cloudflare.com/ajax/libs/foundation/5.4.7/js/foundation/foundation.min', 'libs/foundation/js/foundation/foundation'],
            'foundation.abide': ['//cdnjs.cloudflare.com/ajax/libs/foundation/5.4.7/js/foundation/foundation.abide.min', 'libs/foundation/js/foundation/foundation.abide'],
            'foundation.accordion': ['//cdnjs.cloudflare.com/ajax/libs/foundation/5.4.7/js/foundation/foundation.accordion.min', 'libs/foundation/js/foundation/foundation.accordion'],
            'foundation.alert': ['//cdnjs.cloudflare.com/ajax/libs/foundation/5.4.7/js/foundation/foundation.alert.min', 'libs/foundation/js/foundation/foundation.alert'],
            'foundation.clearing': ['//cdnjs.cloudflare.com/ajax/libs/foundation/5.4.7/js/foundation/foundation.clearing.min', 'libs/foundation/js/foundation/foundation.clearing'],
            'foundation.dropdown': ['//cdnjs.cloudflare.com/ajax/libs/foundation/5.4.7/js/foundation/foundation.dropdown.min', 'libs/foundation/js/foundation/foundation.dropdown'],
            'foundation.equalizer': ['//cdnjs.cloudflare.com/ajax/libs/foundation/5.4.7/js/foundation/foundation.equalizer.min', 'libs/foundation/js/foundation/foundation.equalizer'],
            'foundation.interchange': ['//cdnjs.cloudflare.com/ajax/libs/foundation/5.4.7/js/foundation/foundation.interchange.min', 'libs/foundation/js/foundation/foundation.interchange'],
            'foundation.joyride': ['//cdnjs.cloudflare.com/ajax/libs/foundation/5.4.7/js/foundation/foundation.joyride.min', 'libs/foundation/js/foundation/foundation.joyride'],
            'foundation.magellan': ['//cdnjs.cloudflare.com/ajax/libs/foundation/5.4.7/js/foundation/foundation.magellan.min', 'libs/foundation/js/foundation/foundation.magellan'],
            'foundation.offcanvas': ['//cdnjs.cloudflare.com/ajax/libs/foundation/5.4.7/js/foundation/foundation.offcanvas.min', 'libs/foundation/js/foundation/foundation.offcanvas'],
            'foundation.orbit': ['//cdnjs.cloudflare.com/ajax/libs/foundation/5.4.7/js/foundation/foundation.orbit.min', 'libs/foundation/js/foundation/foundation.orbit'],
            'foundation.reveal': ['//cdnjs.cloudflare.com/ajax/libs/foundation/5.4.7/js/foundation/foundation.reveal.min', 'libs/foundation/js/foundation/foundation.reveal'],
            'foundation.tab': ['//cdnjs.cloudflare.com/ajax/libs/foundation/5.4.7/js/foundation/foundation.tab.min', 'libs/foundation/js/foundation/foundation.tab'],
            'foundation.tooltip': ['//cdnjs.cloudflare.com/ajax/libs/foundation/5.4.7/js/foundation/foundation.tooltip.min', 'libs/foundation/js/foundation/foundation.tooltip'],
            'foundation.topbar': ['//cdnjs.cloudflare.com/ajax/libs/foundation/5.4.7/js/foundation/foundation.topbar.min', 'libs/foundation/js/foundation/foundation.topbar'],
        ...
        shim: {
            ...
            'foundation.core': { deps: ['jquery', 'modernizr', 'fastclick', 'tpl'], exports: 'Foundation' },
